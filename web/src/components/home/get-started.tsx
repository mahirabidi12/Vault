...
const CARDS = [
  {
    ...
    title: "CLI",
    tagline: "For developers: checks the package you install and shows each result. Add --deep for its dependencies.",
    command: "npx pkgguard-cli install express",
    label: "$",
    steps: [
      "Run the command in front of any install.",
      "PkgGuard checks the package and shows what each check found.",
