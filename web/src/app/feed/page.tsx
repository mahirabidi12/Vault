  ...
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-6 px-4 py-10 sm:px-6">
      <div className="flex flex-col gap-2">
        <span className="inline-flex w-fit items-center gap-1.5 rounded-full border border-border bg-card/60 px-3 py-1 text-xs font-medium text-muted-foreground">
          <Radar className="size-3.5" />
          Live threat feed
        </span>
        <h1 className="text-2xl font-semibold tracking-tight">Recently caught packages</h1>
      ...
      <div className="flex flex-col gap-3">
        ...
        {items.map(({ record }) => (
          <Link
            ...
            className="flex flex-col gap-3 rounded-2xl border border-border bg-card/60 p-5 transition-colors hover:border-brand/40 hover:bg-accent/20"
          >
